###################
## This program was designed to take the Dataset Human Activity Recognition
## Using Smartphones and convert it into a mean value tidy data set. it is
## assumed the 'UCI HAR Dataset' has been extracted into a directory by the
## same name and the working directory is set to that folder before running
## it.
##
## The output file will be placed into the same directory withe the name
##
##     "HumanActivityRecognitionMeanData.csv"
##
###################
